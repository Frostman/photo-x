...
public enum TIFFEXIFParser {
    ...
    /// 0x4D ("M").
    public static func parse(_ data: Data) -> ExifSummary? {
    ...
    public enum Endian { case little, big }
    ...
    public struct Reader {
        ...
        public func readValue(typeID: Int, count: Int, valueFieldOffset: Int) -> Value? {
