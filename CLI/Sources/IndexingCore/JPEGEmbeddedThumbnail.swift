...
public enum JPEGEmbeddedThumbnail {
    ...
    public static func extract(from url: URL) throws -> Extracted? {
    ...
    public static func parse(header data: Data) -> Extracted? {
        guard data.count >= 4,
