...
public struct ExifSummary: Hashable, Sendable, Codable {
...
extension ExifSummary {
    ...
    public static func from(exiftoolDict dict: [String: Any]) -> ExifSummary {
        var s = ExifSummary()
    ...
    public static func prettyMake(_ make: String) -> String {
    ...
    public static func formatShutter(_ time: Double) -> String {
        if time <= 0 { return "—" }
